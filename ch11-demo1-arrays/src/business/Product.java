...
public class Product implements Comparable {
	...
	public String toString() {
		return "Product [code=" + code + ", description=" + description + ", price=" + price + ", getCode()="
				+ getCode() + ", getDescription()=" + getDescription() + ", getPriceFormatted()=" + ",price"
				+ "]";
	}
	@Override
	//if this fails then it will return 0
